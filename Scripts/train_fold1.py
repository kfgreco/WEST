...
def train_model(args):
    ...
    for epoch in range(args.num_epochs):
        ...
        if args.local_rank in [-1, 0]:
            ...
            # Save best model
            if val_auc_fold1 > best_val_auc: # can replace val_auc_all with val_auc_fold1 or val_auc_fold2
                best_val_auc = val_auc_fold1 # can replace val_auc_all with val_auc_fold1 or val_auc_fold2
                if args.local_rank != -1:
